...
class ImportantFilesSupport {
     ...
     *
     * @param fileInfoCreator custom {@link FileInfoCreator}, can be
     * {@code null} (in such case,
     * {@link ImportantFilesImplementation.FileInfo#FileInfo(FileObject)} is
     * used)
     * @return information about all important files; can be empty but never
     * {@code null}
     */
    ...
    //~ Inner classes
    /**
     * {@link ImportantFilesImplementation.FileInfo} creator for the given
     * {@link FileObject}.
     */
    public interface FileInfoCreator {

        /**
         * Creates {@link ImportantFilesImplementation.FileInfo} for the given
         * {@link FileObject}.
         *
         * @param fileObject FileObject to be used
         * @return {@link ImportantFilesImplementation.FileInfo} for the given
         * {@link FileObject}, can be {
         * @null}
         */
        @CheckForNull
