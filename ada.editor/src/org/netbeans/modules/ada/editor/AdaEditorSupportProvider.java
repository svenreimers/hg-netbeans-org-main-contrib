 ...
 */
public final class AdaEditorSupportProvider extends AdaCookieProvider {
    ...
    private static class CppEditorSupportFactory implements Convertor<SourceDataObject, AdaEditorSupport> {
        public CppEditorSupportFactory() {
        }

        @Override
        public AdaEditorSupport convert(SourceDataObject obj) {
            return new AdaEditorSupport(obj);
        }

        @Override
        public Class<? extends AdaEditorSupport> type(SourceDataObject obj) {
            return AdaEditorSupport.class;
        }

        @Override
        public String id(SourceDataObject obj) {
            return AdaEditorSupport.class.getName()+obj.getPrimaryFile().getPath();
        }
