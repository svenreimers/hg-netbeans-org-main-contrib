 ...
 */
public class JGnatClean extends JGnatCommand {

    private static final String COMMAND = JVM_GNAT_CLEAN;

    public JGnatClean(JGnatCompiler jgnatCompiler) {
        super(jgnatCompiler);
    }
    ...
    public void invokeCommand(String displayTitle, String args) throws IllegalArgumentException, AdaException {
        ...
        try {
            ...
            adaExec.setCommand(this.getJGnatCompiler().getPlatform().getCompilerPath() + "/" + COMMAND);
