...
public interface HintsProvider {
    ...
    public static abstract class Factory {
        public abstract HintsManager getManagerForMimeType(String mimeType);

        public static HintsManager getManager(String mimeType) {
            Factory factory = Lookup.getDefault().lookup(Factory.class);
            return factory != null ? factory.getManagerForMimeType(mimeType) : null;
        }
    }
}
