...
public class GoToMarkOccurrencesAction extends BaseAction {
    ...
    private static final String prevActionName = "gsf-prev-marked-occurrence"; // NOI18N
    private static final String nextActionName = "gsf-next-marked-occurrence"; // NOI18N
    ...
    private static void navigateToOccurence(boolean next, JTextComponent txt) {
        if (txt != null && txt.getDocument() != null) {
            ...
            if (goTo > 0) {
                ...
                StatusDisplayer.getDefault().setStatusText(NbBundle.getMessage(GoToMarkOccurrencesAction.class, "gsf-no-marked-occurrence"));
            }
        }
